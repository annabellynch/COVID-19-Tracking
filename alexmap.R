...
#import data
map_daily = read.csv("C:/Users/Aditya Kannoth/Desktop/School/SPRING2020/SYS2202/FINALPROJECT/423daily.csv")
...
state_lat_long = read.csv("C:/Users/Aditya Kannoth/Desktop/School/SPRING2020/SYS2202/FINALPROJECT/statelatlong.csv")
...
# Changing the map_daily date format
map_daily$date = gsub("(\\d{4})(\\d{2})(\\d{2})$","\\1-\\2-\\3", map_daily$date)
